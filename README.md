...
For tighter control over the encryption and signing process, the low-level [DynamoDBEncryptor][ddbencryptor] can be used directly for more advanced use cases.
