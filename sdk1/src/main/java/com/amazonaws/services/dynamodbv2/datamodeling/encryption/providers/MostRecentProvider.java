 ...
 * from the {@link ProviderStore} to avoid excessive load on the backing systems. The cache is not
 * currently configurable.
 *
 * @deprecated This provider uses a TTL value to determine when to ping the keystore to get the
 ...
 *     <p>Use the CachingMostRecentProvider, which uses a user defined TTL value to also expire the
 *     cached materials themselves, forcing the keystore to regularly re-obtain materials.
 */
@Deprecated
