 ...
 */
@DynamoDBTable(tableName = "aws-java-sdk-range-test-crypto")
public class RangeKeyTestClass {
    ...
    public String toString() {
        return "RangeKeyTestClass [key=" + key + ", rangeKey=" + rangeKey + ", version=" + version
