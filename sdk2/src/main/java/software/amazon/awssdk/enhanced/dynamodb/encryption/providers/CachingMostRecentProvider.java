...
import static software.amazon.awssdk.enhanced.dynamodb.internal.Utils.checkNotNull;
...
import software.amazon.awssdk.enhanced.dynamodb.internal.TTLCache;
...
public class CachingMostRecentProvider implements EncryptionMaterialsProvider {
  ...
  private final TTLCache.EntryLoader<EncryptionMaterialsProvider> providerLoader =
      new TTLCache.EntryLoader<EncryptionMaterialsProvider>() {
        @Override
