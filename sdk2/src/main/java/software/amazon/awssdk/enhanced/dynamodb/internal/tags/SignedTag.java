...
public class SignedTag implements StaticAttributeTag {

    public static final String CUSTOM_METADATA_KEY_PREFIX = "Encryption:Signed";

    public static SignedTag create() {
        return new SignedTag();
    }
