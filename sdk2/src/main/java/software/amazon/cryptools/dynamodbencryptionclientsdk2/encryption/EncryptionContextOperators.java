...
class EncryptionContextOperators {
     ...
     */
    static UnaryOperator<EncryptionContext> overrideEncryptionContextTableName(
     ...
     * @return A UnaryOperator that produces a new EncryptionContext with the supplied table name
     */
     static UnaryOperator<EncryptionContext> overrideEncryptionContextTableNameUsingMap(
