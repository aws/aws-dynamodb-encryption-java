...
public class ComplexTypeITCase extends DynamoDBMapperCryptoIntegrationTestBase {
    ...
    public static final class ComplexNestedListTypeMarshaller extends JsonMarshaller<List<ComplexNestedType>> {
    ...
    public static final class ComplexClass extends NumberAttributeTestClass {
        ...
        public boolean equals(Object obj) {
            ...
            if (complexNestedTypeList == null) {
                ...
                return false;
            if (extraField == null) {
                return other.extraField == null;
            } else return extraField.equals(other.extraField);
        }
    ...
    public static final class ComplexKey {
        ...
        public boolean equals(Object obj) {
            ...
            if (otherAttribute == null) {
                return other.otherAttribute == null;
            } else return otherAttribute.equals(other.otherAttribute);
        }
    }
