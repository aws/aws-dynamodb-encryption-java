...
//    }
    ...
    private PaginatedList<RangeKeyTestClass> getTestPaginatedQueryList(PaginationLoadingStrategy paginationLoadingStrategy) {
    ...
    private PaginatedList<RangeKeyTestClass> getTestPaginatedScanList(PaginationLoadingStrategy paginationLoadingStrategy) {
        DynamoDBMapperConfig mapperConfig = new DynamoDBMapperConfig(ConsistentReads.CONSISTENT);
        DynamoDBMapper mapper = new DynamoDBMapper(dynamo, mapperConfig);
    ...
    private PaginatedList<RangeKeyTestClass> getTestPaginatedParallelScanList(PaginationLoadingStrategy paginationLoadingStrategy) {
        DynamoDBMapperConfig mapperConfig = new DynamoDBMapperConfig(ConsistentReads.CONSISTENT);
        DynamoDBMapper mapper = new DynamoDBMapper(dynamo, mapperConfig);
    ...
    private void testAllPaginatedListOperations(PaginatedList<RangeKeyTestClass> list) {
    ...
    private void testPaginatedListIterator(PaginatedList<RangeKeyTestClass> list) {
    ...
    private void testIterationOnlyPaginatedListOperations(PaginatedList<RangeKeyTestClass> list) {
        ...
        for (RangeKeyTestClass item : list) {
            assertEquals(hashKey, item.getKey());
            assertTrue(item.getRangeKey() < OBJECTS_NUM);
            // At most one page of results in memory
    ...
    private int getLoadedResultsNumber(PaginatedList<RangeKeyTestClass> list) {
