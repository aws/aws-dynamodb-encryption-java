...
public class MapperSaveConfigCryptoHelper {
    ...
    public static final String hashKeyName = "hashKey";

    public static final String rangeKeyName = "rangeKey";
    ...
    public MapperSaveConfigCryptoHelper(AmazonDynamoDB dynamo) {
        this.dynamo = dynamo;
    }
