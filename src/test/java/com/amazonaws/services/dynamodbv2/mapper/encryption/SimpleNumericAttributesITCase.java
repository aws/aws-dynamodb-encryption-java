...
public class SimpleNumericAttributesITCase extends DynamoDBMapperCryptoIntegrationTestBase {
    ...
    public void testLoad() throws Exception {
        ...
        for (Map<String, AttributeValue> attr : attrs) {
            ...
            assertEquals((Object) x.getBooleanObjectAttribute(), attr.get(BOOLEAN_OBJECT_ATTRIBUTE).getN().equals("1"));
        }
    ...
    public void testUpdate() throws Exception {
        ...
        for (NumberAttributeTestClass obj : objs) {
            ...
            assertNotEquals(replacement.getIgnored(), loadedObject.getIgnored());
    ...
    public void testSetHashKey() throws Exception {
        ...
        for (NumberAttributeTestClass obj : objs) {
            ...
            assertNotEquals(obj.getIgnored(), loadedObject.getIgnored());
    ...
    /**
     * Disabled since there isn't any established criteria for failure.
     */
    @Test(enabled = false)
