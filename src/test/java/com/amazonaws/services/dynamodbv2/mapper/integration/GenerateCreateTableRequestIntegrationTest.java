...
import com.amazonaws.services.dynamodbv2.mapper.encryption.MapperQueryExpressionCryptoTest;
...
public class GenerateCreateTableRequestIntegrationTest extends DynamoDBTestBase {
    ...
    @Test
    public void testParseIndexRangeKeyTestClass() throws Exception {
        CreateTableRequest request = mapper.generateCreateTableRequest(IndexRangeKeyTestClass.class);
    ...
    public void testComplexIndexedHashRangeClass() throws Exception {
        CreateTableRequest request = mapper
                .generateCreateTableRequest(MapperQueryExpressionCryptoTest.HashRangeClass.class);
        String createdTableName = appendCurrentTimeToTableName(request);
        testedTableName.add(createdTableName);
        setProvisionedThroughput(request, DEFAULT_CAPACITY);
